...
| --- | --- | --- | --- | --- | --- |
| `codex/osr-1-set-up-ai-docs-harness-and-default-mcp-tooling` | active | Initial AI docs harness setup and MCP defaults | [OSR-1](https://linear.app/hutechventures/issue/OSR-1/set-up-ai-docs-harness-and-default-mcp-tooling) | 2026-06-16 | Establish lightweight workflow docs before implementation tasks. |
