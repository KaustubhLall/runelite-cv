...
- Current automation follow-up order: right-click/menu-option attack reliability for obstructed targets; separate loot loop after drop spawn delay; HP/food thresholds; inventory fullness; pathing/exit strategy.
