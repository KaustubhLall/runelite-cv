...
- Current automation follow-up order: real route/path distance; right-click/menu-option attack reliability for obstructed targets; separate loot loop after drop spawn delay; HP/food thresholds; inventory fullness and protected-item dropping; login/reconnect/world recovery; pathing/exit strategy.
