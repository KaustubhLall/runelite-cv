...
- Implemented on 2026-06-18: CV Helper has configurable RuneLite hotkeys for debug status, bounds printing, raw screen capture, entity refresh, and nearest-entity target logging. These are helper/export hotkeys only; direct prayer/spell activation remains an explicit future boundary decision.
