...
function pathingBody(status, player, candidates, selected, tileGrid) {
	...
	return `
		...
		<div class="path-legend"><span><i class="lg-you"></i>You</span><span><i class="lg-path"></i>Target</span><span><i class="lg-target"></i>Selected</span><span><i class="lg-obstacle"></i>Obstacle</span><span><i class="lg-unreachable"></i>Unreachable</span><span><i class="lg-door-pending"></i>Pending door</span><span><i class="lg-door-blocked"></i>Blocked door</span><span><i class="lg-multi-transition"></i>Multi-transition</span><span><i class="lg-failed-transition"></i>Failed step</span><span><i class="lg-door"></i>Door</span></div>`;
}
